...
using ProjetoSalesMVC.Models.Enums;
namespace ProjetoSalesMVC.Data {
    public class SeedingService {
        private ProjetoSalesMVCContext _context;
        ...
        public void Seed() {
            ...
            Seller s6 = new Seller(6, "Ray Pink", "ray@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
